export const STATUS_BADGE = {
  ...
  PENDING_REPLACEMENT_HANDOVER: "bg-purple-50 text-purple-700 border border-purple-200",
  REPLACED_BEFORE_DEPOSIT: "bg-slate-100 text-slate-600 border border-slate-200",
  REPLACED_AFTER_DEPOSIT: "bg-slate-100 text-slate-600 border border-slate-200",
  TERMINATED: "bg-zinc-100 text-zinc-700 border border-zinc-200",
  DEPOSIT_REFUND_PENDING: "bg-fuchsia-50 text-fuchsia-700 border border-fuchsia-200",
...
export const STATUS_LABEL = {
  ...
  PENDING_REPLACEMENT_HANDOVER: "Chờ bàn giao thay thế",
  REPLACED_BEFORE_DEPOSIT: "Đã thay thế (chưa cọc)",
  REPLACED_AFTER_DEPOSIT: "Đã thay thế (đã cọc)",
  TERMINATED: "Đã chấm dứt",
  DEPOSIT_REFUND_PENDING: "Chờ hoàn cọc",
  INSPECTION_DONE: "Đã kiểm tra bàn giao",
