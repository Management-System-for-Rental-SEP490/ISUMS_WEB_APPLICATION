...
export default function HouseStatusDonut({ propertyStats, loading = false }) {
  ...
  const donutData = [
    {
      name: t("dashboard.houseStatus.rented"),
      value: rented,
      color: "#3bb582",
    },
    {
      name: t("dashboard.houseStatus.vacant"),
      value: available,
      color: "#2096d8",
    },
    ...(other > 0
      ? [
          {
            name: t("dashboard.houseStatus.other"),
            value: other,
            color: "#f59e0b",
          },
        ]
  ...
  return (
    <div
      ...
      style={{
        ...
        border: "1px solid #C4DED5",
        boxShadow:
          "0px 1px 3px 0px rgba(16,24,40,0.08), 0px 1px 2px 0px rgba(16,24,40,0.04)",
      }}
    >
      <div
      ...
      <div className="p-5 md:p-6 flex flex-col flex-1">
        ...
        <p className="text-sm font-bold mb-4" style={{ color: "#1E2D28" }}>
          {loading
            ? t("dashboard.houseStatus.loading")
            : t("dashboard.houseStatus.distribution", { total })}
        </p>

        {loading ? (
          <div
            className="flex-1 min-h-[160px] rounded-xl animate-pulse"
