...
function CustomTooltip({ active, payload, label, contractUnit }) {
  ...
  return (
    ...
    >
      <p className="font-medium mb-0.5" style={{ color: "#5A7A6E" }}>
        {label}
      </p>
      <p className="text-base font-bold" style={{ color: BRAND_GREEN }}>
        {payload[0].value}
        <span className="text-xs font-normal ml-1" style={{ color: "#8ab5a3" }}>
          {contractUnit}
        </span>
      </p>
    </div>
          ...
          {loading ? (
            ...
            <div className="h-full flex items-center justify-center">
              <p className="text-xs" style={{ color: "#8ab5a3" }}>
                {t("dashboard.contractsByMonth.noData")}
              </p>
            </div>
          ) : (
            <ResponsiveContainer width="100%" height="100%">
              ...
              >
                ...
                />
                <Tooltip
                  content={<CustomTooltip contractUnit={contractUnit} />}
