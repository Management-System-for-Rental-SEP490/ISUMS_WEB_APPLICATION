...
const RANGE_TABS = [
  { key: "T",    label: "T",    data: CONTRACTS_BY_MONTH_DATA.slice(-1)  },   // tháng này (dùng full làm demo)
  { key: "3T",   label: "3T",   data: CONTRACTS_3M_DATA                  },
  { key: "6T",   label: "6T",   data: CONTRACTS_6M_DATA                  },
  { key: "Năm",  label: "Năm",  data: CONTRACTS_BY_MONTH_DATA            },
];
...
export default function ContractsByMonthLine() {
  ...
  const current = RANGE_TABS.find((t) => t.key === activeTab);
            ...
            {RANGE_TABS.map((tab) => {
              ...
              return (
                <button
                  ...
                  className="px-2.5 py-1.5 rounded-md text-[11px] font-semibold transition-all duration-150 min-w-[32px]"
                  style={{
          ...
          <ResponsiveContainer width="100%" height="100%">
            ...
            >
              ...
              <Tooltip
                ...
                cursor={{ stroke: "rgba(59,181,130,0.15)", strokeWidth: 1 }}
              />
              <Area
                type="monotone"
                dataKey="contracts"
