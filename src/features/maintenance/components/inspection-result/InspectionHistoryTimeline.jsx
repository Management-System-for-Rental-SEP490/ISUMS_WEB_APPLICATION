...
export default function InspectionHistoryTimeline({
  history = [],
  inspection,
}) {
  return (
              ...
              <div className="flex flex-col items-center flex-shrink-0">
                ...
                {idx < history.length - 1 && (
                  <div
                    ...
                    style={{ background: "#E5E7EB", minHeight: 20 }}
                  />
                )}
              </div>
      ...
      >
        <div className="relative h-44 overflow-hidden">
          ...
          <div
            ...
            style={{
              background:
                "linear-gradient(to top, rgba(30,45,40,0.55) 0%, transparent 60%)",
            }}
          />
