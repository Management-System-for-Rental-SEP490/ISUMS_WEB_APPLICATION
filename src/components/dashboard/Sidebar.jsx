  ...
  const sections = [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "maintenance-inspections", label: "Kiểm tra nhà cửa", icon: ClipboardList, path: "/maintenance/inspections" },
      ],
    },
    {
      id: "sua-chua-group",
          ...
          {isExpanded ? (
            <div className="flex items-center gap-3 px-4 py-3.5">
              ...
              <div className="min-w-0 flex-1">
                <h1 className="font-extrabold text-sm tracking-wide truncate" style={{ color: "#3bb582" }}>ISUMS</h1>
                ...
                {section.collapsible ? (
                  ...
                  >
                    <span
                      ...
                      style={sectionHasActive ? { color: "#3bb582" } : undefined}
                    >
                      {section.label}
                    </span>
                    <ChevronDown
                    ...
                    {section.items.map((item) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          <span className={["text-sm flex-1 text-left", isActive ? "font-semibold" : ""].join(" ")}>{item.label}</span>
                          {item.badge > 0 && (
                            <span className={[
